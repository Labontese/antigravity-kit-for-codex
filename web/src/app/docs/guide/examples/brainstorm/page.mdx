export const metadata = {
  title: "Example: Structured Brainstorming | Codex Kit",
  ...
  <div className="space-y-4 pl-8 mb-4">
    <div className="border-t border-zinc-800 pt-3">
      ...
      <div className="text-xs mt-1 space-y-1">
        <div className="text-green-400">âœ… Minimal re-renders, great DX</div>
        <div className="text-red-400">âŒ Learning curve</div>
        <div className="text-yellow-400">ðŸ“Š Effort: Low</div>
      </div>
    </div>
    <div className="border-t border-zinc-800 pt-3">
      <strong className="text-purple-400">Option B: Zustand</strong>
      <div className="text-xs mt-1 space-y-1">
        <div className="text-green-400">âœ… Full control, persists across routes</div>
        <div className="text-red-400">âŒ More boilerplate</div>
        <div className="text-yellow-400">ðŸ“Š Effort: Medium</div>
      </div>
    </div>
  </div>

  <TerminalBlock highlight>
    <TerminalLine type="agent">**ðŸ’¡ Recommendation: Option A**</TerminalLine>
