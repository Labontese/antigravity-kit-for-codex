export const metadata = {
  title: "Example: Preview Management | Codex Kit",
...
<Terminal>
  ...
  <TerminalBlock>
    <TerminalLine type="agent">**ðŸš€ Starting preview...**</TerminalLine>
  ...
  <TerminalBlock highlight>
    <TerminalLine type="agent">**âœ… Preview ready!**</TerminalLine>
