export const metadata = {
  title: "Example: Advanced UI Design | Codex Kit",
...
<Terminal>
  ...
  <TerminalBlock>
    ...
    <div className="text-xs text-zinc-500 mt-2">
      <div>ðŸŽ¨ <strong>Colors:</strong> Indigo-500 primary, Slate-900 bg</div>
      <div>âœ¨ <strong>Effects:</strong> Glassmorphism cards</div>
    </div>
  </TerminalBlock>

  <TerminalBlock highlight>
    <TerminalLine type="agent">**âœ… Page Complete!**</TerminalLine>
