export const metadata = {
  title: "Example: Project Status | Codex Kit",
...
<Terminal>
  ...
  <TerminalBlock>
    ...
    <div className="space-y-1 mb-4">
      <div>ðŸ“ Project: my-ecommerce</div>
      <div>ðŸ·ï¸ Type: nextjs-ecommerce</div>
      <div>ðŸ“„ Files: 73 created, 12 modified</div>
    </div>

    <div className="text-yellow-400 mb-2">=== Agent Status ===</div>
    <div className="space-y-1 mb-4">
      <div><span className="text-green-400">âœ…</span> database-architect â†’ Completed</div>
      <div><span className="text-green-400">âœ…</span> backend-specialist â†’ Completed</div>
      <div><span className="text-blue-400">ðŸ”„</span> frontend-specialist â†’ 60%</div>
    </div>

    <div className="text-yellow-400 mb-2">=== Preview ===</div>
    <div className="space-y-1">
      <div>ðŸŒ URL: <span className="text-blue-400">http://localhost:3000</span></div>
      <div>ðŸ’š Health: <span className="text-green-400">OK</span></div>
    </div>
  </TerminalBlock>
</Terminal>
