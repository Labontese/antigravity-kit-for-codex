export const metadata = {
  title: "Example: Production Deployment | Codex Kit",
  ...
  <Step number={2} title="Pre-Flight Checklist">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
      <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-3">
        <h4 className="text-sm font-semibold mb-1">ðŸ›¡ï¸ Security</h4>
        <p className="text-xs text-zinc-500 dark:text-zinc-400 m-0">Scans for vulnerabilities & secrets</p>
      </div>
      <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-3">
        <h4 className="text-sm font-semibold mb-1">ðŸ“‹ Quality</h4>
...
<Terminal>
  ...
  <TerminalBlock>
    ...
    <div className="space-y-1 mt-2">
      <div>ðŸ”„ Security Scan... <span className="text-green-400">PASSED</span></div>
      <div>ðŸ”„ Lint Check... <span className="text-green-400">PASSED</span></div>
      <div>ðŸ”„ Type Validation... <span className="text-green-400">PASSED</span></div>
    </div>
    <br/>
    <span className="text-green-400">âœ… All checks passed!</span>
    Deploying to Vercel...
  </TerminalBlock>

  <TerminalBlock highlight>
    <TerminalLine type="agent">**ðŸš€ Deployment Complete!**</TerminalLine>
    <div className="space-y-1 mt-2">
      <div>ðŸŒ URL: <span className="text-blue-400">https://my-app.vercel.app</span></div>
      <div>ðŸ’š Health Check: <span className="text-green-400">OK</span></div>
    </div>
  </TerminalBlock>
</Terminal>
